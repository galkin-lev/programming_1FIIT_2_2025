...
#ifndef LAB6_LOGIN_REGISTRATION_LOGGER_H
#define LAB6_LOGIN_REGISTRATION_LOGGER_H
...
namespace logging {
    ...
    namespace detail {
        ...
        inline bool shouldLog(Level level) {
            auto& state = getState();
            return true;
            // static_cast<int>(level) >= static_cast<int>(state.minLevel);
        }
...
#endif //LAB6_LOGIN_REGISTRATION_LOGGER_H