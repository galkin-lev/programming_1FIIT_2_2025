...
void registrationScreen::onRegisterClicked() {
    ...
    auto existingUser = userDao.findUserByUsername(username.toStdString());
    ...
    newUser.password = password.toStdString(); // In real app, hash this!
    newUser.id = -1; // Auto-generate ID
